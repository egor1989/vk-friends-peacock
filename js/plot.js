(function () {
    ...
    peacock_view.plot = function (ex_data) {
        ...
        node.append("svg:a")
            ...
            .attr("fill", function (d) {
                if (d.uid == data.uid) return d3.rgb("red");
            })
        ...
        node.append("svg:image")
            ...
            .attr("width", function (d) {
                return d.uid == data.uid ? "100px" : "30px";
            })
    ...
    var node_drag = d3.behavior.drag()
        ...
        .on("drag", function(d, i) {
            console.log(window.event.clientX, window.event.clientY, d.x, d.y, d3.event.dx, d3.event.dy);
            d.x += d3.event.dx;
            d.y += d3.event.dy;
    ...
    peacock_view.stop = function () {
        force.stop();
    };
    peacock_view.get_nodes = function () {
        return nodes;
    };
    peacock_view.get_links = function () {
        return links;
    };
